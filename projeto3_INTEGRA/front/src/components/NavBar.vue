...
export default {
    ...
    mounted: function() {
        AuthService.getAuthenticatedUser().then((response) => {
...
<template>
    <nav
        class="h-16 bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <RouterLink :to="{ path: '/' }" class="flex items-center justify-between mr-4">
                    <img src="../assets/logo.svg" class="mr-3 h-10" alt="PGS Logo" />
